...
const {createProd, updateProd, listProd} = require("../services/prod.service")
...
exports.updateProduto = async(req, res, next)=> {
    try {
        ...
        const response = await updateProd(idProduto, req.body) 
        res.status(200).send({message: "item editado"});
